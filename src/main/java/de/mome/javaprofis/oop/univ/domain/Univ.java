...
public class Univ implements IUniv {
    ...
    private final static List<UniMember> UNI_MEMBERS = new ArrayList<>();

    @Override
    public UniStaff addNewStudent(final String firstname, final String lastname, final String birthdate) {
    ...
    public List<IStaffRO> currentStaff() {
        ...
        final Iterator<UniMember> iterator = UNI_MEMBERS.iterator();
